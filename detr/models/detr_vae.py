...
class DETRVAE(nn.Module):
    ...
    def __init__(self, backbones, transformer, encoder, state_dim, qpos_dim, num_queries, camera_names):
...
class CNNMLP(nn.Module):
    ...
    def forward(self, qpos, image, env_state, actions=None):
        ...
        features = torch.cat([flattened_features, qpos], axis=1) # qpos: qpos_dim
